...
TSharedRef<IDetailCustomization> FCusMaterialInstanceParameterDetails::MakeInstance(UMaterialEditorInstanceConstant* MaterialInstance, FGetShowHiddenParameters InShowHiddenDelegate)
{
	return MakeShareable(new FCusMaterialInstanceParameterDetails(MaterialInstance, InShowHiddenDelegate));
}

FCusMaterialInstanceParameterDetails::FCusMaterialInstanceParameterDetails(UMaterialEditorInstanceConstant* MaterialInstance, FGetShowHiddenParameters InShowHiddenDelegate)
